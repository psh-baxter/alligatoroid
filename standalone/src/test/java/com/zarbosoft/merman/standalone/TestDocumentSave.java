...
public class TestDocumentSave {
  public void check(Syntax syntax, final TreeBuilder tree, final String result) {
    ...
    Context context = Helper.buildDoc(syntax, tree.build());
    Assert.assertThat(new String(context.serializer.write(context.document.root), StandardCharsets.UTF_8), CoreMatchers.equalTo(result));
  }
