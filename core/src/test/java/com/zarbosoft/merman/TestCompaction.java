  ...
  public void testSplitOnResize() {
    ...
    final FreeAtomType one =
        new TypeBuilder("one")
            ...
            .build();
    final FreeAtomType initialSplitOne =
    ...
    final FreeAtomType comboText =
        new TypeBuilder("comboText")
            ...
            .frontMark("123")
            .build();
    final FreeAtomType initialSplitText =
        new TypeBuilder("splitText")
            .back(Helper.buildBackDataPrimitive("value"))
            .front(
                new FrontPrimitiveSpec(new FrontPrimitiveSpec.Config("value").splitMode(COMPACT)))
            .build();
  ...
  public void testExpandPrimitiveOrder() {
    ...
    final Syntax syntax =
        new SyntaxBuilder("any")
            ...
            .group(
                "any",
                new GroupBuilder().type(one).type(low).type(mid).type(initialSplitText).build())
            .build();
    new GeneralTestWizard(
            syntax,
            new TreeBuilder(low)
  ...
  public void testExpandEdge() {
    ...
    final Syntax syntax =
        new SyntaxBuilder("any")
            ...
            .type(initialSplitOne)
            .type(line)
            .group("any", new GroupBuilder().type(one).type(initialSplitOne).type(line).build())
            .build();
    new GeneralTestWizard(
            syntax,
  ...
  public void testCompactWindowDown() {
    ...
    final Syntax syntax =
        new SyntaxBuilder("any")
            ...
            .group(
                "any",
                new GroupBuilder().type(one).type(two).type(low).type(mid).type(high).build())
            .build();
    final Atom midAtom =
        new TreeBuilder(mid)
            .addArray(
